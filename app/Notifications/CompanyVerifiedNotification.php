...
class CompanyVerifiedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->line('Congratulations! <b>'.$this->user->name.'</b>. Your company has been successfully verified. You are now officially listed on our platform and visible in search results. This means you can start connecting with new clients and expanding your business opportunities.')
